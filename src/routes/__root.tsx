...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  // Log the error for debugging — visible in both server console and browser devtools
  console.error("[VisionTale] Route error:", error);
  ...
  head: () => ({
    meta: [
      ...
      { title: "Neuralcast — AI Story Video Generator" },
      {
        name: "description",
        content:
          "Generate cinematic short stories with scene-by-scene AI visuals and narration. Built for creators.",
      },
      { property: "og:title", content: "Neuralcast — AI Story Video Generator" },
      {
        property: "og:description",
        content: "Turn a single idea into a cinematic story with AI-generated visuals.",
      },
